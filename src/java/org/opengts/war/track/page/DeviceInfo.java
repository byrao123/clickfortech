    ...
    implements Constants
{
  ...
  //public  static final String PARM_WORKORDER_ID           = "d_workid";
    ...
    private static long GetDayNumber(DateTime.DateStringFormat dsf, String ymd)
    {
        if (StringTools.isBlank(ymd)) {
            return 0L;
        } else {
    ...
    private String _updateDeviceTable(RequestProperties reqState)
    {
      ...
      //String  worderID    = AttributeTools.getRequestString(request, PARM_WORKORDER_ID      , "");
        try {
            ...
            // fuel capacity
            boolean editFuelCap = privLabel.hasWriteAccess(currUser, this.getAclName(_ACL_FUEL_CAPACITY));
            ...
            // fuel economy (km/L)
            boolean editFuelEcon = privLabel.hasWriteAccess(currUser, this.getAclName(_ACL_FUEL_ECONOMY));
            if (showFuelEcon) {
        ...
        HTMLOutput HTML_JS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                ...
                if (showDateCal)  {
                    ...
                    out.write("// Last Service date Calendar vars \n");
