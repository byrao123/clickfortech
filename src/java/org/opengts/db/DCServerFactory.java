...
public class DCServerFactory {
    ...
    *
    ...
    /* */
    public static final String FA888_NAME = "fa888";          // [31280]
    ...
    /**
     *** Gets the specific DCServerConfig name, or null if there is no specific
     * DCServerConfig.
     *
    ...
    *
    ...
    public enum ResultCode implements EnumTools.StringLocale, EnumTools.StringValue {
        ...
        ResultCode(String c, I18N.Text a) {
            cc = c;
            aa = a;
        }
        ...
        public boolean isSuccess() {
            return this.equals(SUCCESS) || this.equals(COMMAND_QUEUED);
        }
    };
     ...
     *** @param dft The default ResultCode to return if the specified code is
     * undefined.
    ...
    *
    ...
    /**
     *** Gets the full path name of the 'dcservers.xml' file based on the
     * location ** of the loaded rutime configuration file.
    *
     */
 ...
 /* clear for garbage collection (no longer needed) */
    ...
    *
                                ...
                                if (cmdTagName.equalsIgnoreCase(TAG_Command)) {
                                    ...
                                    if (cmdEnable || !cmdDiscard) {
                                        ...
                                        for (int s = 0; s < cmdSubNodes.getLength(); s++) {
                                            ...
                                            if (!(cmdSubNode instanceof Element)) {
                                                continue;
                                            }
     ...
     *
     *** @param portStr A String containing a comma-separated list of port
     * numbers.
        ...
        if (DCServerFactory.dcServerMap == null) {
            if (dispError && (BasicPrivateLabel.isTrackServlet() || RTConfig.isCommandLine())) {
                if (DCServerFactory.HasSpecificDCServerName()) {
                    ...
                    Print.log(1,"!!!!!.... Where is the GPS Device server ? Looks like you forgot to start it ...  To start it use below command  ");
                    Print.log(1," Use command runServer.bat/sh server port:<port number> ");
    ...
    *
    ...
    /**
     *** Returns the DCServerConfig instance for the specified device
    ...
    *
     ...
     *
     *** @param name The name of the device communication server
     *** @param warn If true, a warning message will be displayed if "name"
     * does not exist.
     *** @return The DCServerConfig instance
    *
     */
    ...
    *
     ...
     *
     *** @param inclAll True to include all DCS modules register, false to only
     * include ** DCS modules for which the DCS jar file was also found.
    ...
    *
    ...
    /**
     *** (used by CheckInstall) Return the number of refererenced servers which
     * are undefined
    *
     */
    ...
    /**
     *** (used by CheckInstall) Returns the list of referenced, but undefined,
     * servers
    *
     */
    ...
    *
    ...
    /**
     *** Returns true if the server for the specified Device supports a command
     * port
    *
     */
    ...
    *
    ...
    /**
     *** Return true if the ResultCode represents a successful
     * request/operation
    *
     */
    ...
    *
    ...
    /**
     *** Send a command request to the server command port for the specified
     * Device
    *
     */
    public static RTProperties sendServerCommand(
        ...
        if ((device != null) && DCServerFactory.isCommandResultOK(resp)) {
            ...
            if (!ListTools.isEmpty(cmdArgs)) {
                cmdStr += "(" + StringTools.join(cmdArgs, ",") + ")";
            }
            Audit.deviceCommand(acctID, userID, devID, ipAddr, cmdStr);
        } else {
    ...
    *
    ...
    // ------------------------------------------------------------------------
    /**
     *** Analyzes/Prints the current memory usage. ** (see
     * OSTools.checkMemoryUsage) 
    *
     */
    ...
    *
     ...
     *** @param prefix An array of unique-id prefixes
     *** @param modemID The unique modem ID (IMEI, ESN, etc)
     *** @param serverID The server-id (also 'device code'), used for
     * UnassignedDevice entries
     *** @param ipAddress The inbound IP address, used for UnassignedDevice
     * entries
     *** @param isDuplex True if duplex, false if simplex, used for
     * UnassignedDevice entries
     *** @param geoPoint The GPS location of the device, used for
     * UnassignedDevice entries
     *** @return The Device record
    *
     */
     ...
     *** @param prefix An array of unique-id prefixes
     *** @param modemID The unique modem ID (IMEI, ESN, etc)
     *** @param saveUnassigned True to save Device to UnassignedDevices, if
     * device is not found
     *** @param serverID The server-id (also 'device code'), used for
     * UnassignedDevice entries
     *** @param ipAddress The inbound IP address, used for UnassignedDevice
    ...
    *
    ...
    /**
     *** Return an array of "Command Protocol" property names ** Return command
     * protocol to used when communicating with remote devices
     *
     *** @param name The server name
    ...
    *
    ...
    /**
     *** Return an array of "Status Location/InMotion Translation" property
     * names
     *
     *** @param name The server name
     *** @return An array of "Status Location/InMotion Translation" property
    ...
    *
    ...
    /**
     *** Return an array of "Use Alternate Current Timestamp for Event"
     * property names
     *
     *** @param name The server name
     *** @return An array of "Use Alternate Current Timestamp for Event"
